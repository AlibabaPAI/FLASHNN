...
class TestLogitsProcessor(unittest.TestCase):
    def test_bladnn_repetition_and_presence_penalty(self):
        ...
        p = tri_blade.LogitsProcessor(penalty_ty="REPETITION")
        p(
        ...
        tri_blade.set_use_triton(False)
        p = tri_blade.LogitsProcessor(penalty_ty="PRESENCE")
        p(
        ...
        tri_blade.set_use_triton(True)
        presence_p = tri_blade.LogitsProcessor(penalty_ty="PRESENCE")
        presence_p(
            scores,
            presence_penalty_tensor,
            input_ids_ptr_tensor,
